...
<nav id="navigation" class="style-1">
    ...
    <ul class="menu" id="responsive">
        <li><a href="index.html" id="current"><i class="halflings white home"></i> 首页 </a></li>
        <li><a href="about.html"><i class="halflings white file"></i> 关于我们 </a></li>
